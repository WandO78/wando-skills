...
**Summary:** X/17 PRESENT, Y/17 PARTIAL, Z/17 MISSING
...
1. [Most urgent action — usually CLAUDE.md or test setup]
2. [Second priority]
3. [Third priority]
...
- Gap Analysis table with status for all 17 standard elements
...
- Gap analysis incomplete (fewer than 17 elements checked)
